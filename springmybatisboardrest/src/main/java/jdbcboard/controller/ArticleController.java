...
public class ArticleController {
	...
	public ModelAndView getArticle(@PathVariable Integer aid) {
	...
	public ModelAndView updateArticleForm(@PathVariable String aid) {
		ModelAndView mav = new ModelAndView();
		Article article = articleService.getArticle(Integer.parseInt(aid));
	...
	@ResponseBody
	public Map<String, Integer> deleteArticle(@PathVariable Integer aid) {
